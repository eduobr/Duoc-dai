        ...
        <div>
            <form action="proceso.php" method="post" onsubmit="return validaFormulario()">
                <table border="1" >
                    <tr>
                        <td colspan="2" 
                            style="background-color: activecaption; text-align: center;font-size: 20px;">
                            Formulario Encuesta de Servicios
                        </td>
                    </tr>
                    <tr>
                        <td>Rut:</td> 
                        <td> <input type="text" name="txtRut"
                                    id="txtRut" required
                                    maxlength="12"
                                    placeholder="Ingrese Rut Ej. 11.111.111-1"
                                    pattern="[0-9]{2}.[0-9]{3}.[0-9]{3}-[0-9kK]"></td>
                    </tr>
                    <tr>
                        <td>Nombre:</td> 
                        <td>
