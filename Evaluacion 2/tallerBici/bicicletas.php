...
if (isset($_GET["mensaje"])) {
    echo "<script>alert(" . $_GET["mensaje"] . ");location.href='bicicletas.php'</script>";
}
?>
<html>
    <head>
    ...
    <body>
        ...
        $reg = $conexion->query("SELECT * FROM PRODUCTO WHERE TIPOBICICLETA IS NOT NULL AND CLIENTE_RUT IS NULL AND DARBAJA='NO';");
        ?>
        <div class="container">
            <h1>Bicicletas</h1>
            <div class="row">
                                        ...
                                        <div class="modal-content">
                                            <form id="frmDarBaja" action="proceso.php" method="post">
                                                ...
                                                <div class="modal-footer"> 
                                                    ...
                                                    <input type="hidden" id="txtUrl" name="txtUrl" value="bicicletas.php">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
