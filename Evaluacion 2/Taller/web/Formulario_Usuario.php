                    ...
                    <table>
                        ...
                        <tr>
                            <td class="col-md-4 col-sm-6 portfolio-item">
                                <img style="width: 360px; height: 240px;" src="../img/accesorios/Asiento Bontrager Community Dama WSD $24.990.jpg" class="img-responsive" alt="">
                                <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i>COMPRAR</button>
                                <div class="portfolio-caption">
                                    <h4>Asiento Bontrager Community Dama WSD </h4>
                                    <p class="text-muted">$24.990</p>
                                </div>
                            </td>
                            <td class="col-md-4 col-sm-6 portfolio-item">
                                <img style="width: 360px; height: 240px;" src="../img/accesorios/Asiento Negro-Verde $15.000.jpg" class="img-responsive" alt="">
                                <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i>COMPRAR</button>
                                <div class="portfolio-caption">
                                    <h4>Asiento Negro-Verde </h4>
