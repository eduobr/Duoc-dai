                ...
                <div>
                    ...
                    <center>
                        <table>
                            <tr>
                                <td class="form-group">
                                    <input style="width: 150px;" type="text" name="txtUsuario" class="form-control" placeholder="usuario *" required data-validation-required-message="Campo Vacio">
                                    <p class="help-block text-danger"></p>
                                </td>
                                <td class="form-group">
                                    <input style="width: 150px;" type="password" name="txtPass" class="form-control" placeholder="password *" required data-validation-required-message="Campo Vacio">
                                    <p class="help-block text-danger"></p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <button type="submit" name="btnEntrar" class="btn btn-primary" ><i class="fa fa-times"></i>Entrar</button>
                                </td>
                            </tr>
                        </table>
                    </center>
