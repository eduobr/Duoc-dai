            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h2 class="section-heading">VENDE O COMPRA PRODUCTOS DE OTROS USUARIOS</h2>
                        <h3 class="section-subheading text-muted">consigue los mejores productos</h3>
                    </div>
                </div>
                <div>
                    <center>
                        <form method="post" action="" enctype="multipart/form-data">
                            <table class="row">
                                <tr class="form-group">
                                    <td class="form-group">
                                        <input style="width: 500px;" type="text" name="txtArticulo"class="form-control" placeholder="Nombre Articulo" required data-validation-required-message="Campo Vacio">
                                ...
                                <tr>
                                    <td class="form-group">
                                        <input style="width: 500px;" type="file" name="filFoto" accept=".jpg, .jpeg, .png" class="form-control" placeholder="Titulo" required data-validation-required-message="Campo Vacio">
                                        <p class="help-block text-danger"></p>
                                    </td>
                                </tr>  
                                <tr>
                                    <td>
                                        <button type="submit" value="Crear Tema" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i>Crear Tema</button>
                                    </td>
                                </tr>
                            </table>
                        </form>
